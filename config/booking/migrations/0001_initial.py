# Generated by Django 6.1.1 on 2026-09-21 11:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'Bemor'), ('doctor', 'Shifokor'), ('admin', 'Admin')], default='patient', max_length=10, verbose_name='Roli')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Kutilmoqda'), ('confirmed', 'Tasdiqlandi'), ('cancelled', 'Bekor qilindi'), ('completed', 'Yakunlandi')], default='pending', max_length=15, verbose_name='Holati')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointments', to=settings.AUTH_USER_MODEL, verbose_name='Shifokor')),
            ],
        ),
        migrations.CreateModel(
            name='DoctorProfile',
